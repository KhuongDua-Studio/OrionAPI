# Orion Library
This documentation is for the stable release of Orion Library (recode).

## Booting the Library
```lua
local OrionLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/KhuongDua-Studio/OrionAPI/refs/heads/main/resource/main.lua", true))()
```
